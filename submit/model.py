...
class model:
    def __init__(self):
        ...
        self.checkpoints4 = ['ResNext_best_fold_1.pt', 'ResNext_best_fold_2.pt',
                             'ResNext_best_fold_3.pt', 'ResNext_best_fold_4.pt']
        self.checkpoints5 = ['SeResNext_best_fold_1.pt', 'SeResNext_best_fold_2.pt',
                             'SeResNext_best_fold_3.pt', 'SeResNext_best_fold_4.pt']
        ...
        if not self.multi_folds:
            ...
            if not self.multi_models:
                if self.model_name == '50d':
                    ...
                    tmp_mode = ResNext(num_classes=2)
                    checkpoints = self.checkpoints4
                elif self.model_name == 'SeResNext':
                    tmp_mode = SeResNext(num_classes=2)
